...
public class Solution {
    ...
    {
        Map<Integer, Boolean> tagIndexes = new TreeMap<Integer,Boolean>();
        Map<Integer, Integer> finalIndexes = new TreeMap<Integer, Integer>();
        Stack<Integer> openTagsStack = new Stack<Integer>();
